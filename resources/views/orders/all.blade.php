        ...
        <div class="row">
            <div class="col">
                <div class="card card-primary card-outline">
                    <div class="card-header">Semua Request</div>
                    <div class="card-body">
                        @if (session('status'))
...
$(document).ready( function () {
    $('#historyTable').DataTable({
        serverSide: true,
        ajax: "{!! route('api.history', ['api_token' => Auth::user()->api_token]) !!}",
        columns: [
            ...
            { data: 'assign.fullname', title: 'Kepada'},
        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row, meta) {
                    return `<div class="btn-group align-middle text-center">
                                <a href="/order/detail/${row.wo_number}" class="btn btn-sm btn-primary" title="Detail"><i class="fas fa-search"></i></a>
                                <a href="/order/edit-status/${row.wo_number}" class="btn btn-sm btn-success" title="Edit"><i class="fas fa-edit"></i></a>
