        ...
        <div class="row">
            <div class="col">
                <div class="card card-primary card-outline">
                    <div class="card-header">Request Order</div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ url()->current() }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category" id="category" class="form-control">
                                    ...
                                    <option value="technical" @if (old('category') == 'technical') selected @endif>Teknis</option>
                                    <option value="nontechnical" @if (old('category') == 'nontechnical') selected @endif>Non Teknis</option>
                                </select>
                            </div>
                            <div class="form-group">
